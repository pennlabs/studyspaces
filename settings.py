...
DATABASE_NAME = 'studyspaces'             # Or path to database file if using sqlite3.
DATABASE_USER = 'studyspaces'             # Not used with sqlite3.
#DATABASE_PASSWORD = None         # Not used with sqlite3. SET IN SANDBOX_CONFIG
