...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_building', 'latitude', self.gf('django.db.models.fields.FloatField')(default=13.369999999999999), keep_default=False)

        # Adding field 'Building.longitude'
        db.add_column('app_building', 'longitude', self.gf('django.db.models.fields.FloatField')(default=42), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Building.latitude'
        db.delete_column('app_building', 'latitude')

        # Deleting field 'Building.longitude'
        db.delete_column('app_building', 'longitude')
